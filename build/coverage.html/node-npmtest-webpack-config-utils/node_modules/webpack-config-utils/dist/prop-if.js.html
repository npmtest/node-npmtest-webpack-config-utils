...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webpack-config-utils/node_modules/webpack-config-utils/dist/prop-if.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webpack-config-utils/node_modules/webpack-config-utils/dist/prop-if.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webpack-config-utils/node_modules/webpack-config-utils/dist/</a> &#187; prop-if.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function propIf(add, value, alternate) {</span>
<span class="cstat-no" title="statement not covered" >  return getValue(add) ? value : alternate;</span>
}
&nbsp;
/**
 ...
 * @return {*} The value based on whether `add` evaluates to truthy
 */
<span class="fstat-no" title="function not covered" >function propIfNot(add, value, alternate) {</span>
<span class="cstat-no" title="statement not covered" >  return propIf(add, alternate, value);</span>
}
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function getValue(val) {</span>
