...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webpack-config-utils/node_modules/webpack-config-utils/dist/get-if-utils.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-webpack-config-utils">npmtest-webpack-config-utils (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-webpack-config-utils/node_modules/webpack-config-utils/dist/get-if-utils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webpack-config-utils/node_modules/webpack-config-utils/dist/</a> &#187; get-if-utils.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function getIfUtils(env) {</span>
<span class="cstat-no" title="statement not covered" >  var vars = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : ['production', 'prod', 'test', 'development', 'dev'];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  env = typeof env === 'string' ? _defineProperty({}, env, true) : env;</span>
<span class="cstat-no" title="statement not covered" >  if ((typeof env === 'undefined' ? 'undefined' : _typeof(env)) !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('webpack-config-utils:getIfUtils: env passed should be a string/Object. Was ' + JSON.stringify(env));</span>
  }
<span class="cstat-no" title="statement not covered" >  return vars.reduce(<span class="fstat-no" title="function not covered" >function (utils, variable) {</span></span>
<span class="cstat-no" title="statement not covered" >    var envValue = !!env[variable];</span>
<span class="cstat-no" title="statement not covered" >    var capitalVariable = capitalizeWord(variable);</span>
<span class="cstat-no" title="statement not covered" >    utils['if' + capitalVariable] = <span class="fstat-no" title="function not covered" >function (value, alternate) {</span></span>
<span class="cstat-no" title="statement not covered" >      return isUndefined(value) ? envValue : (0, _propIf.propIf)(envValue, value, alternate);</span>
    };
<span class="cstat-no" title="statement not covered" >    utils['ifNot' + capitalVariable] = <span class="fstat-no" title="function not covered" >function (value, alternate) {</span></span>
<span class="cstat-no" title="statement not covered" >      return isUndefined(value) ? !envValue : (0, _propIf.propIfNot)(envValue, value, alternate);</span>
    };
<span class="cstat-no" title="statement not covered" >    return utils;</span>
  }, {});
}
&nbsp;
// utilities
&nbsp;
<span class="fstat-no" title="function not covered" >function capitalizeWord(word) {</span>
<span class="cstat-no" title="statement not covered" >  return word.substring(0, 1).toUpperCase() + word.substring(1);</span>
}
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Mon Apr 24 2017 10:53:25 GMT+0000 (UTC)</div>
</div>
</body>
</html>
